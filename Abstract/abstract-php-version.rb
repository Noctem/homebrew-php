class AbstractPhpVersion < Formula
  ...
  module Php54Defs
    PHP_SRC_TARBALL = 'https://www.php.net/get/php-5.4.33.tar.bz2/from/this/mirror'
    PHP_GITHUB_URL  = 'https://github.com/php/php-src.git'
    PHP_VERSION     = '5.4.33'
    PHP_BRANCH      = 'PHP-5.4'
  ...
  module Php55Defs
    PHP_SRC_TARBALL = 'https://www.php.net/get/php-5.5.18.tar.bz2/from/this/mirror'
    PHP_GITHUB_URL  = 'https://github.com/php/php-src.git'
    PHP_VERSION     = '5.5.18'
    PHP_BRANCH      = 'PHP-5.5'
  ...
  module Php56Defs
    PHP_SRC_TARBALL = 'https://www.php.net/get/php-5.6.3.tar.xz/from/this/mirror'
    PHP_GITHUB_URL  = 'https://github.com/php/php-src.git'
    PHP_VERSION     = '5.6.3'
    PHP_BRANCH      = 'PHP-5.6'
    ...
    PHP_CHECKSUM    = {
                        ...
                        :sha1   => '5f5d54c1711e74b6000b829d925c741fd95f52ce',
